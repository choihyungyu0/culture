...
export const problem = {
  ...
  note:
    "* 아래 수치는 공개 인구통계에 예시 공급 데이터를 결합한 탐색용 진단입니다. 실측 데이터로 교체 시 실제 격차가 산출됩니다.",
...
export const ask = {
  ...
  greeting:
    "안녕하세요. CULTURE TWIN 정책 분석 어시스턴트입니다. 지역과 개입(강사·프로그램 수)을 말씀하시면 트윈이 반응하고, 사각지대 변화를 함께 해석해 드립니다. 예: \"전남에 강사 15명을 추가하면?\"",
  placeholder: "예: 전남에 강사 15명을 추가하면 사각지대가 얼마나 줄어드나요?",
  suggestions: [
    "사각지대가 가장 심한 지역은 어디인가요?",
    "전남에 강사 15명을 추가하면?",
    "공급은 많은데 경험이 낮은 곳은?",
    "경북과 충남 중 어디가 더 시급한가요?",
  ],
  appliedPrefix: "트윈 반영",
  disclaimer:
