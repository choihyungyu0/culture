...
export const problem = {
  ...
  note:
    "* 17개 시·도 공급 지표(인구·프로그램·밀도)는 공개데이터 실측입니다 — 행안부 주민등록인구(2026-06)와 문화예술교육 프로그램 목록(2025-12)을 운영주소 기준 시·도로 지오코딩(커버리지 ~83%). 제주 6.94 최고 · 울산 1.20 최저 · 전국 평균 2.72 · 최대 5.8배. 경험률은 국민문화예술활동조사 기반 탐색용 추정입니다.",
